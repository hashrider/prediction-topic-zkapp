...
impl MarketData {
    pub fn new(title: String, description: String, start_time: u64, end_time: u64, resolution_time: u64) -> Result<Self, u32> {
        ...
        // We'll use DEFAULT_MARKET.initial_yes_liquidity / initial_no_liquidity
        // as "seed shares" to avoid ln(exp(0)+exp(0)) edge cases.
        validate_liquidity(DEFAULT_MARKET.initial_yes_liquidity)?;
        validate_liquidity(DEFAULT_MARKET.initial_no_liquidity)?;
        validate_b(DEFAULT_MARKET.lmsr_b)?;
        ...
        Ok(MarketData {
            ...
            total_yes_shares: DEFAULT_MARKET.initial_yes_liquidity,
            total_no_shares:  DEFAULT_MARKET.initial_no_liquidity,

            b: DEFAULT_MARKET.lmsr_b,
